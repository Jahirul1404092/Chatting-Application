...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public ChatAdapter(Context mContext, List<Profile> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        myViewHolder.chat_item.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
...
//                Toast.makeText(mContext,mData.get(myViewHolder.getAdapterPosition()).getImageDownloadUrl(),Toast.LENGTH_LONG).show();
        ...
        myViewHolder.chat_item.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        if(mData.get(i).getPassword().equals("Used")) {
...
//        }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            chat_item=(LinearLayout)itemView.findViewById(R.id.chat_item_Id);
            tv_name=(TextView)itemView.findViewById(R.id.name_chat_Id);
            tv_phone=(TextView)itemView.findViewById(R.id.last_msg_chat_Id);
